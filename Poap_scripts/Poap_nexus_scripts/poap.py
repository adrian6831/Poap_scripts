#!/bin/env python
#md5sum="f734327630e2e1e9864e2fda93cfac1f"
"""
...
def get_version(): #research assignment 1: image version can be seen in this function. Note r"Str" make "Str" a raw string
    """
...
def is_bios_upgrade_needed(): #research assignment 2: no update bio
    """
...
def set_next_upgrade_from_upgrade_path(): # research assignment 2: prevent upgrade from here
